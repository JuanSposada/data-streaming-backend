...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in transfer_pb2_grpc.py depends on'
...
def add_FileServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'transfer.v1.FileService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('transfer.v1.FileService', rpc_method_handlers)
