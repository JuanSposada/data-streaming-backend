...
type FileServiceClient interface {
	// streaming bidirrecional: el cliente pide y recibe
	//
...
func (c *fileServiceClient) StreamFile(ctx context.Context, in *FileRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[FileResponse], error) {
...
func _FileService_StreamFile_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(FileServiceServer).StreamFile(m, &grpc.GenericServerStream[FileRequest, FileResponse]{ServerStream: stream})
}
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "transfer.v1.FileService",
